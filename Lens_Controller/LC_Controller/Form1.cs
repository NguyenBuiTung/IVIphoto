...
namespace LC_Controller
{
    public partial class Form1 : Form
    {
        ...
        public bool UpdateFocus(ushort focus)
        {
            ...
            while (!FocusBar.Enabled && DateTime.Now.Subtract(Begin).TotalSeconds > 10) { Thread.Sleep(500); }
        ...
        public bool UpdateIris(ushort iris)
        {
            ...
            DateTime Begin = DateTime.Now;
            while (!IrisBar.Enabled && DateTime.Now.Subtract(Begin).TotalSeconds > 10) { Thread.Sleep(500); }
